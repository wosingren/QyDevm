 ...
 * 添加回库单
 */
public class HkOneFragment extends Fragment {
    ...
    private void onInit() {
        ...
        btHk = (Button) getView().findViewById(R.id.btRk);
        ...
        btHk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hkOneDevice();
            }
    ...
    private void hkOneDevice() {
        ...
        OkHttpUtils.post().url(HttpUrl.hkOneDevice)
                .addParams("IMEI",IMEI)
